...
class AssociationSubscriptionsScreenTest {
    ...
    @Test
    fun unfollowButtonShouldChangeUserProfile() {
        composeTestRule.onNodeWithTag("testAI-action-button").performClick()
        verify { userProfileViewModel.setUserProfile(UserProfile.EMPTY) }
    }
}
