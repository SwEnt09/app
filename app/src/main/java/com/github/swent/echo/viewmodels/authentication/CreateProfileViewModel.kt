...
constructor(
  ...
  fun profileSave(firstName: String, lastName: String) {
    ...
    if (userId == null) {
      ...
      runBlocking {
        ...
        // val selectedSemester = SemesterEPFL.entries.firstOrNull { it.name == semester }
        ...
        if (userProfile != null) {
          ...
          repository.setUserProfile(
              UserProfile(
                  ...
                  tags = _tagList.value,
                  committeeMember = emptySet(),
                  associationsSubscriptions = emptySet()))
        }
      }
    }
    // }
